...
Object3D::Object3D(BFSOctree *data, bool rhsCoordianteSystem)
    : m_data(data), m_rhsCoordSystem(rhsCoordianteSystem) {
...
BFSOctree const *Object3D::data() const { return m_data.get(); }

BFSOctree *Object3D::data() { return m_data.get(); }

float4x4 const &Object3D::transform() const { return m_transform; }